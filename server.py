...
class AnalyticsServiceServicer(analytics_pb2_grpc.AnalyticsServiceServicer):
    def __init__(self):
        ...
        self.event_queue = Queue()  # Cria uma fila para armazenar os eventos recebidos
    ...
    def SendEvent(self, request, context):
        ...
        # Simplesmente enfileira o evento recebido para ser processado posteriormente
    ...
    def process_events(self):
        while True:
            ...
            if json_data is None:  # Um sinal de None é usado para parar o thread
                break
...
def serve():
    ...
    try:
        ...
        servicer.event_queue.put(None)  # Sinaliza para o thread de processamento parar
